...
def bot():
    ...
    usuario = credenciales['values'][0][0]
    clave = credenciales['values'][0][1]
        ...
        if num_filas > 0:
            ...
            if banco == 'BOD' and tipo == 'Sell':
                ...
                if error is None:
                    ...
                    accion_votc.click()
                    time.sleep(5)
                    item_votc = driver.find_element_by_xpath("//li[normalize-space()='Cancel, Account Number Not Found']")
            ...
            #Entradas
                ...
                try:
                    ...
                    print(("Datos de transaccion"),
                          ("Nombre", "RSV", "Tasa", "Monto", "Numero de REF"),
                          (nombre_reserve, rsv, tasa, monto1, confirmacion)
                         )
                except:
                    driver.quit
